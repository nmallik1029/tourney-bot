...
async def start_webhook_server():
    ...
    from views.pickban import WEBHOOK_URL
    print(f"[Webhook] Hosted games will POST results to: {WEBHOOK_URL}")
    print("[Webhook] (Local testing: set WEBHOOK_URL in .env.test to an ngrok/cloudflared tunnel, "
          "or results go to production and your local bot won't see them.)")
